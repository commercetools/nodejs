...
export function NetworkError (...args) { defineError.call(this, 0 /* special code to indicate network errors */, ...args) }
export function HttpError (...args) { defineError.call(this, /* code will be passed as arg */...args) }
