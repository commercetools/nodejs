...
describe('price actions', () => {
  ...
  describe('changeValue', () => {
    ...
    test('should generate changeValue action for staged prices', () => {
      const before = {
        id: '9fe6610f',
        staged: {
          value: {
    ...
    test('should not generate changeValue action when `staged.discounted` changes', () => {
      const before = {
        id: '9fe6610f',
        staged: {
          value: {
      ...
      const now = {
        ...
        staged: {
          ...
          discounted: {
            ...
            discount: { typeId: 'product-discount', id: 'pd2' },
          },
        },
      }
    ...
    test('should generate two changeValue actions when `value` and `staged` at the same time', () => {
      const before = {
        id: '9fe6610f',
        value: {
          type: 'centPrecision',
